  ...
  .then(x => {
    ...
    // Before adding any recipes to the database, let's remove all existing ones
      ...
      /*return Recipe.create({
        ...
        cuisine: 'American',
        dishType: 'dessert',
        image: 'https://media.istockphoto.com/id/517109442/photo/chocolate-chip-cookie-isolated.jpg?s=612x612&w=0&k=20&c=RgZOYwzVRTXnIBy8zSkXK-wJfNBy9w023UGULkbH_VE=',
        duration: 30,
        creator: 'Amber Moody'
      });
    })
